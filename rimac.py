...
class Credentials():
    ...
    def __init__(self):
        self.__username = "fred2.test@rimac.com.pe"
        self.__AccessKey = "GHIA3UMGUVIY5FS2PO5D"
        self.__password = "pruebadeseguridad"
        self.__SecretKey = "fgT8FM+yStjsBGo+kIbe5jOrRoQpwXsqyA0N6HYY"
